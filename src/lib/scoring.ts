import { FinancialSnapshot, RiskProfile, ScoreBreakdown, QuantScore, AgentOutput, CompetitorBenchmark } from "./types/research";
...
export function calculateAdvancedScores(
  ...
  if ((snapshot.debtToEquity ?? 0) > 1.5) { healthScore -= 20; healthNegatives.push("High debt burden."); }
