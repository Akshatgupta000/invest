...
exports.createEvidenceItem = createEvidenceItem;
exports.buildFinancialEvidence = buildFinancialEvidence;
exports.buildHistoricalEvidence = buildHistoricalEvidence;
exports.buildNewsEvidence = buildNewsEvidence;
exports.buildCompetitorEvidence = buildCompetitorEvidence;
exports.getEvidenceByMetric = getEvidenceByMetric;
exports.getPositiveEvidence = getPositiveEvidence;
exports.getNegativeEvidence = getNegativeEvidence;
function createId() {
...
function buildFinancialEvidence(snapshot) {
    const evidence = [];
...
function buildHistoricalEvidence(trends) {
    const evidence = [];
...
function buildNewsEvidence(newsItems, sentiment) {
...
function buildCompetitorEvidence(benchmarks) {
...
function getEvidenceByMetric(evidence, metric) {
    return evidence.filter((e) => e.relatedMetric === metric);
}
function getPositiveEvidence(evidence) {
    return evidence.filter((e) => e.direction === "positive");
}
function getNegativeEvidence(evidence) {
