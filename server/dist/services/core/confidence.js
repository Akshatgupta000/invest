export function calculateConfidence(snapshot, historical, competitors, news, agentOutputs) {
    let score = 100;
    const reasons = [];
    const limitations = [];
    ...
    if (score >= 80)
        ...
        level = "low";
    if (score >= 80)
        reasons.push("Data is comprehensive and historical trends are clear.");
    return {
        score,
        level,
        reasons,
