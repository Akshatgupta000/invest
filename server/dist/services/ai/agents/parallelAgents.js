...
export async function runBullAgent(context) {
    const prompt = `
...
export async function runBearAgent(context) {
    const prompt = `
...
export async function runRiskAgent(context) {
    const prompt = `
...
export async function runValuationAgent(context) {
    const prompt = `
...
export async function runNewsAgent(context) {
    const prompt = `
