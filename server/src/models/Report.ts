...
export interface IReport extends Document {
  ...
  confidence?: any; // Kept optional for older reports, now an object in new pipeline
...
const Report = (models.Report as mongoose.Model<IReport>) || model<IReport>("Report", ReportSchema);
