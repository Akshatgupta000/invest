import { AgentOutput, EvidenceItem, AuditTrailItem } from "../../utils/types/research";

export function verifyClaimsAndBuildAuditTrail(
  ...
  for (const [agentName, output] of Object.entries(agentOutputs)) {
    if (!output || !output.arguments) continue;
